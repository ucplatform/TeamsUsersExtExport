...
$uri = "https://samsteamsextension.blob.core.windows.net/msteamsextension/$($CustID)?sp=acl&st=2024-10-16T08:04:18Z&se=2026-10-29T17:04:18Z&spr=https&sv=2022-11-02&sr=c&sig=$key"
